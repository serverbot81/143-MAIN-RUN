...
async function makeImage({ one, two }) {
    ...
    pairing_img.composite(circleOne.resize(220, 220), 980, 200).composite(circleTwo.resize(220, 220), 140, 200);
