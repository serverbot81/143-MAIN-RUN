module.exports.config = {
  ...
  version: "1.0.0", 
  permission: 0,
  credits: "Hungcho modify: Tanvir143",
  description: "তর্নানির হেডফোন",
  prefix: true,
  category: "random-img", 
  usages: ".partner", 
  cooldowns: 5,
...
module.exports.run = async function({ api, event, args, Users, Threads, Currencies }) {
        ...
        api.changeNickname(`${name}s Property 🔐😘`, event.threadID, event.senderID);
        api.changeNickname(`${namee}s Property🔐😘`, event.threadID, id);
